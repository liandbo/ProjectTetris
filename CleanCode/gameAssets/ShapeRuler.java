...
public class ShapeRuler implements ShapeInterface {
	...
	private static int yy4=GameVariables.getPredictionY()+2*GameVariables.getBlockSize();
	...
	public void setBlock() {
		...
		case 3:			
			...
			x4=x;																y4=y+GameVariables.getBlockSize()+GameVariables.getBlockSize();
			break;
		case 2:
		case 4:
			x1=x;																y1=y;
			...
			x4=x+GameVariables.getBlockSize()+GameVariables.getBlockSize();	y4=y;
			break;
		}
