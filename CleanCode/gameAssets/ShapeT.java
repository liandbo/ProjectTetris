...
public class ShapeT implements ShapeInterface {
	...
	private static int xx2=GameVariables.getPredictionX()-GameVariables.getBlockSize();
	private static int xx3=GameVariables.getPredictionX()+GameVariables.getBlockSize();
	private static int xx4=GameVariables.getPredictionX();
	
	private static int yy1=GameVariables.getPredictionY();
	private static int yy2=GameVariables.getPredictionY();
	private static int yy3=GameVariables.getPredictionY();
